...
public class CalimotoTegolaHillshadeActivity extends MapActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        BitmapTileSource backgroundTileSource = BitmapTileSource.builder()
                ...
                .url(GlobalConfig.HILLSHADE_SERVER_DNS)
                .tilePath("/{Z}/{X}/{Y}.png")
                .tileSize(512)
                .build();

        mMap.layers().add(0, new BitmapTileLayer(mMap, backgroundTileSource, 0.27f));
        ...
        mMap.setTheme(VtmThemes.CALIMOTO_ONLINE_HILLSHADE);
