...
public class MapsforgeActivity extends MapActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.calimoto:
                mMap.setTheme(VtmThemes.CALIMOTO);
                item.setChecked(true);
                return true;
    
            case R.id.calimoto_navigation:
                mMap.setTheme(VtmThemes.CALIMOTO_NAVIGATION);
                item.setChecked(true);
                return true;
    
            case R.id.calimoto_roadtrip:
                mMap.setTheme(VtmThemes.CALIMOTO_ROADTRIP);
                item.setChecked(true);
                return true;
    
            case R.id.calimoto_roadtrip_navigation:
                mMap.setTheme(VtmThemes.CALIMOTO_ROADTRIP_NAVIGATION);
                item.setChecked(true);
                return true;
    
            case R.id.calimoto_myspin:
                mMap.setTheme(VtmThemes.CALIMOTO_MYSPIN);
                item.setChecked(true);
                return true;
