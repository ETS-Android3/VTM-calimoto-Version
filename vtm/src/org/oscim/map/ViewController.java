...
public class ViewController extends Viewport {
    ...
    private Runnable mActionAfterScale = null;
    private Runnable mActionAfterRotate = null;
    private Runnable mActionAfterTilt = null;
    ...
    public void setAfterScale(Runnable actionAfterScale) {
        mActionAfterScale = actionAfterScale;
    }
    
    public void afterScale() {
        if (mActionAfterScale != null) {
            mActionAfterScale.run();
        }
    }
    ...
    public void setAfterRotate(Runnable actionAfterRotate) {
        mActionAfterRotate = actionAfterRotate;
    }
    
    public void afterRotate() {
        if (mActionAfterRotate != null) {
            mActionAfterRotate.run();
        }
    }
    ...
    public void setAfterTilt(Runnable actionAfterTilt) {
        mActionAfterTilt = actionAfterTilt;
    }
    
    public void afterTilt() {
        if (mActionAfterTilt != null) {
            mActionAfterTilt.run();
        }
    }
