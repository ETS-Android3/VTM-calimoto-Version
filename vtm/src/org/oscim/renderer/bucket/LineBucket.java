...
public class LineBucket extends RenderBucket {
    static final Logger log = new Logger(LineBucket.class);
        ...
        public static RenderBucket draw(RenderBucket b, GLViewport v,
            ...
            for (; b != null && b.type == RenderBucket.LINE; b = b.next) {
                ...
                if (!line.outline) {
                    ...
                    } else if (line.minWidth > 0) {
                        width = Math.max(
                                line.minWidth / scale,
                                VectorTileLoader.getLineScale(v.pos.y, v.pos.scale) * line.width / scale);
                    } else {
                ...
                for (LineBucket ref = lb.outlines; ref != null; ref = ref.outlines) {
                    ...
                    if (core.fixed) {
                        ...
                        width = Math.max(
                                line.minWidth / scale,
                                VectorTileLoader.getLineScale(v.pos.y, v.pos.scale) * core.width / scale);
                    } else {
